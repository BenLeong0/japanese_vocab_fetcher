...
class JishoExpectedSection(MyBaseModel):
...
class JishoTestDict(MyBaseModel):
...
class OjadExpectedSection(MyBaseModel):
...
class OjadTestDict(MyBaseModel):
...
class SuzukiExpectedSection(MyBaseModel):
...
class SuzukiTestDict(MyBaseModel):
...
class WadokuExpectedSection(MyBaseModel):
...
class WadokuTestDict(MyBaseModel):
...
class ForvoExpectedSection(MyBaseModel):
...
class ForvoTestDict(MyBaseModel):
...
class JapanesePodExpectedRow(MyBaseModel):
    """
...
class JapanesePodExpectedSection(MyBaseModel):
...
class JapanesePodTestDict(MyBaseModel):
...
class TangorinExpectedSection(MyBaseModel):
...
class TangorinTestDict(MyBaseModel):
...
class WanikaniTestDict(MyBaseModel):
...
class FullTestDict(MyBaseModel):
    ...
    expected_result: list[FullResponseItem]
